...
À ce jour, **aucune entrée n'a jamais été retirée du catalogue** — ni à la
demande d'une entreprise, ni sur décision de justice, ni pour aucun autre
motif. Cette phrase n'est pas une déclaration d'intention : le compteur en tête
de [REGISTRE.md](REGISTRE.md) est recalculé à chaque mise à jour et affichera
le contraire dès le premier retrait.
